...
class WishListProductDetailsSection extends StatefulWidget {
  const WishListProductDetailsSection({super.key,required this.contentDetailsModel});
final ContentDetailsModel contentDetailsModel;
  @override
  State<WishListProductDetailsSection> createState() => _WishListProductDetailsSectionState();
}

class _WishListProductDetailsSectionState extends State<WishListProductDetailsSection> {
  @override
