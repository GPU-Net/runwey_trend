...
class _SummerGownTopSectionState extends State<SummerGownTopSection> {
  ...
  final _detailsController =Get.put(WishListContentDetailsController());
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        WishListUrlVideoView(url:_detailsController.contentDetailsModel.value.attributes!.video!.videoPath??"",thumbnail:_detailsController.contentDetailsModel.value.attributes!.video!.thumbnailPath!),
        Container(
