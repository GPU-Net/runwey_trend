...
class WishListAlertDialogBoxe extends StatefulWidget {
  const WishListAlertDialogBoxe({super.key});

  @override
  State<WishListAlertDialogBoxe> createState() => _WishListAlertDialogBoxeState();
}

class _WishListAlertDialogBoxeState extends State<WishListAlertDialogBoxe> {
