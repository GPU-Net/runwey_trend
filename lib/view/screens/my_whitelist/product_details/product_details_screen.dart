...
class WishListProductDetailsScreen extends StatefulWidget {
  const WishListProductDetailsScreen({super.key});

  @override
  State<WishListProductDetailsScreen> createState() => _WishListProductDetailsScreenState();
}

class _WishListProductDetailsScreenState extends State<WishListProductDetailsScreen> {
  var id = Get.arguments;
  final _contentDetailsController = Get.put(WishListContentDetailsController());
                  ...
                  return  SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        WishListProductDetailsSection(contentDetailsModel:_contentDetailsController.contentDetailsModel.value,),

                    if(_contentDetailsController.contentDetailsModel.value.attributes!.reviews!.isNotEmpty)
                       WishListTopReviewsSection(contentDetailsModel:_contentDetailsController.contentDetailsModel.value,),
                        WishListDescriptionSection(contentDetailsModel:_contentDetailsController.contentDetailsModel.value,),
