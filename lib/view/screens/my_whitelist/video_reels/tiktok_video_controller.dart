...
class WishListTikTokVideoController extends StatefulWidget {
  const WishListTikTokVideoController({super.key, required this.contentModel});
  final ContentModel contentModel;

  @override
  State<WishListTikTokVideoController> createState() => _WishListTikTokVideoControllerState();
}

class _WishListTikTokVideoControllerState extends State<WishListTikTokVideoController> {
            ...
            children: [
              ...
              GestureDetector(
                  onTap: (){
                    ...
                    Get.toNamed(AppRoute.wishListProductDetailsScreen,arguments: widget.contentModel.id);
                  },
