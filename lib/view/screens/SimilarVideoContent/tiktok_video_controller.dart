...
import 'Controller/video_reels_controller.dart';

class TikTokVideoController extends StatefulWidget {
  const TikTokVideoController({super.key, required this.contentModel});
  final ContentModel contentModel;

  @override
  State<TikTokVideoController> createState() => _TikTokVideoControllerState();
}

class _TikTokVideoControllerState extends State<TikTokVideoController> {
   late VideoPlayerController videoPlayerController;
  late bool isVideoInitialized=false;
  late bool isPlaying;
final _controller =Get.put(SimilarVideoReelsController());
  @override
  void initState() {
    super.initState();
            ...
            children: [
              ...
              GestureDetector(
                  onTap: (){
                    ...
                    Get.toNamed(AppRoute.similarProductDetailsScreen,arguments:widget.contentModel.id);
                  },
