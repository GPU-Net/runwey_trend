...
class NewestTikTokVideoController extends StatefulWidget {
  const NewestTikTokVideoController({super.key, required this.contentModel});
  final ContentModel contentModel;

  @override
  State<NewestTikTokVideoController> createState() => _NewestTikTokVideoControllerState();
}

class _NewestTikTokVideoControllerState extends State<NewestTikTokVideoController> {
            ...
            children: [
              ...
              GestureDetector(
                  onTap: (){
                    ...
                    Get.toNamed(AppRoute.productDetailsScreen,parameters:{"contentId":widget.contentModel.id!,"screenType":ProductScreenType.newest.name});
                  },
