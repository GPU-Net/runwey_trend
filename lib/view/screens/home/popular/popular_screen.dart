...
import 'package:runwey_trend/view/screens/home/popular/inner_widgets/popular_end_drawer.dart';
import 'package:runwey_trend/view/screens/home/popular/inner_widgets/popular_product_section.dart';
      ...
      child: Obx(() {
        switch (_controller.rxRequestStatus.value) {
          case Status.loading:
            return  Scaffold(
              appBar: AppBar(
                title: const Text(AppStrings.popular),
          ...
          Expanded(
            child: Padding(
                ...
                child: _controller.searchLoading.value
                    ...
                    : _controller.popularContentList.isEmpty
                    ? const Center(
                  child: Text(
                    "No data found",
                    style: TextStyle(
