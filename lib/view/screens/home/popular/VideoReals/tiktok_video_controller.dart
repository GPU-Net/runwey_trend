...
class PopularTikTokVideoController extends StatefulWidget {
  const PopularTikTokVideoController({super.key, required this.contentModel});
  final ContentModel contentModel;

  @override
  State<PopularTikTokVideoController> createState() => _PopularTikTokVideoControllerState();
}

class _PopularTikTokVideoControllerState extends State<PopularTikTokVideoController> {
            ...
            children: [
              ...
              GestureDetector(
                  onTap: (){
                    ...
                    Get.toNamed(AppRoute.productDetailsScreen,parameters:{"contentId":widget.contentModel.id!,"screenType":ProductScreenType.popular.name});
                  },
