...
class PopularEndDrawer extends StatefulWidget {
  const PopularEndDrawer({super.key});

  @override
  State<PopularEndDrawer> createState() => _PopularEndDrawerState();
}

class _PopularEndDrawerState extends State<PopularEndDrawer> {
