...
class UploadVideoEndDrawer extends StatefulWidget {
  const UploadVideoEndDrawer({super.key});

  @override
  State<UploadVideoEndDrawer> createState() => _UploadVideoEndDrawerState();
}

class _UploadVideoEndDrawerState extends State<UploadVideoEndDrawer> {
