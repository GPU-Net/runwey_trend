...
class TopReviewsSection extends StatefulWidget {
  const TopReviewsSection({super.key, required this.contentDetailsModel});
  final ContentDetailsModel contentDetailsModel;
  @override
  State<TopReviewsSection> createState() => _TopReviewsSectionState();
}

class _TopReviewsSectionState extends State<TopReviewsSection> {
