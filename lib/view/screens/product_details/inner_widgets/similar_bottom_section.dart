...
class _SimilarBottomSectionState extends State<SimilarBottomSection> {
  ...
  final SimilarVideoReelsController _similarVideoReelsController =
      Get.put(SimilarVideoReelsController());
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
              children: List.generate(
                  _similarVideoReelsController.contentList.length,
                  (index) => SimilarVideoCard(
                        videoListModel:
                            _similarVideoReelsController.contentList[index],
                        ontap: () {
                          if (_videoWidgetController
                              .videoPlayerController.value.isInitialized) {
                            _videoWidgetController.videoPlayerController
                                .pause();
                            _videoWidgetController.chewieController.pause();
                          }
                          Get.to(SimilarVideoReelsScreen(
                            contentId: _similarVideoReelsController
        ...
        Row(
          children: [
            ...
            Expanded(
              flex: 1,
              child: Obx(() => NewCustomButton(
                    onTap: () {
                      _contentDetailsController.addWishList(
                          widget.contentDetailsModel.attributes!.video!.id ??
                              "");
                    },
                    text: AppStrings.addToWishlist,
                    loading: _contentDetailsController.wishListAddLoading.value,
                  )),
              // child: CustomButton(
              //   rightPadding: 26,
              //   leftPadding: 26,
