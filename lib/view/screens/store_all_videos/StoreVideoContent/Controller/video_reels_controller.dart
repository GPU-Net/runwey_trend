...
class StoreVideoReelsController extends GetxController {
  ...
  getVideoList(String contentId,String userId) async {
    loading(true);
    debugPrint( "${ApiConstant.storeListContent + contentId}/$userId?page=$page");
    var response = await ApiClient.getData(
        "${ApiConstant.storeListContent + contentId}/$userId?page=$page");
  ...
  loadMoreGetVideoList(String contentId,String userId) async {
