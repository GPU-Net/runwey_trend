...
class _SimilarBottomSectionState extends State<SimilarBottomSection> {
  ...
  final _contentDetailsController = Get.put(StoreProductDetailsController());
  ...
  Widget build(BuildContext context) {
    return Column (
      ...
      children: [
        ...
        //   child: Row(
        //       children: List.generate(widget.contentDetailsModel.attributes!.similarVideos!.length,
        //               (index) => SimilarVideoCard(videoListModel:widget.contentDetailsModel.attributes!.similarVideos![index]))),
        // ),
