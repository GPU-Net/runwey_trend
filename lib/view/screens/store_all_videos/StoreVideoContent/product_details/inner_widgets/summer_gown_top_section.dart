...
import 'package:runwey_trend/view/screens/SimilarVideoContent/widget/url_video_widget.dart';
import 'package:runwey_trend/view/screens/store_all_videos/Controller/store_controller.dart';
...
class _SummerGownTopSectionState extends State<SummerGownTopSection> {
  ...
  final _detailsController =Get.put(StoreProductDetailsController());
  @override
  void initState() {
    super.initState();
