...
class StoreTikTokVideoController extends StatefulWidget {
  const StoreTikTokVideoController({super.key, required this.contentModel});
  final ContentModel contentModel;

  @override
  State<StoreTikTokVideoController> createState() => _StoreTikTokVideoControllerState();
}

class _StoreTikTokVideoControllerState extends State<StoreTikTokVideoController> {
            ...
            children: [
              ...
              GestureDetector(
                  onTap: (){
                    ...
                    Get.toNamed(AppRoute.storeProductDetailsScreen,arguments:widget.contentModel.id!,);
                  },
