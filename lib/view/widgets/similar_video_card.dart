...
import '../screens/SimilarVideoContent/video_reels_screen.dart';
import '../screens/video_reels/Controller/url_video_controller.dart';
import 'image/custom_image.dart';

class SimilarVideoCard extends StatelessWidget {
   SimilarVideoCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    // Get.to(SimilarVideoReelsScreen(contentId: videoListModel.id??"",));
      },
      child: Container(
                         ...
                         Positioned(
                            ...
                            child: Row(
                              children: [
                                ...
                                CustomText(
                                  text: Helper.formatDuration(videoListModel.duration??0),
                                  color: AppColors.white,
                                  fontSize: 12,
                                  left: 6,
                                )
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  RatingBar.builder(
                    itemSize: 12,
                    initialRating:videoListModel.ratings?.toDouble()??0,
                    minRating: 1,
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          CustomText(
                            text: Helper.formatLikeAndViewCount(videoListModel.popularity??0),
                            color: AppColors.black_60,
                            fontSize: 12,
                            left: 4,
                          )
